...
class RoverState():
    def __init__(self):
        ...
        self.time_stuck = 0 # To record moment that got stuck
        self.time_rock = 0 # To record moment that started to go for the near rock sample
        ...
        self.rocks_angles = None  # Angles of rock sample pixels
        self.rocks_dists = None  # Distances of rock sample pixels
...
def telemetry(sid, data):
    ...
    if (time.time() - second_counter) > 1:
        ...
        frame_counter = 0
        second_counter = time.time()
    print("Mohamed Yossef Noorhan Salma")
